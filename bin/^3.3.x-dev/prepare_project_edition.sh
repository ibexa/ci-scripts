...
composer create-project mnocon/website-skeleton:^3.3@dev ${PROJECT_BUILD_DIR} --no-install --no-scripts --repository='{"type": "vcs","url": "https://github.com/mnocon/website-skeleton"}'
