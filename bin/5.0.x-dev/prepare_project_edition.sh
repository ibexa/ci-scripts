...
docker compose --env-file=.env exec -T --user www-data app sh -c "php bin/console ibexa:doctrine:schema:dump-sql \"\$(cat vendor/ibexa/collaboration/src/bundle/Resources/config/schema.yaml | grep -v '\-- ')\""
docker compose --env-file=.env exec -T --user www-data app sh -c "php bin/console ibexa:doctrine:schema:dump-sql \"\$(cat vendor/ibexa/share/src/bundle/Resources/config/schema.yaml | grep -v '\-- ')\""
docker compose --env-file=.env exec -T --user www-data app sh -c "php bin/console ibexa:doctrine:schema:dump-sql \"\$(cat vendor/ibexa/connector-ai/src/bundle/Resources/config/schema.yaml | grep -v '\-- ')\""
