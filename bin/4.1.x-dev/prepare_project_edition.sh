...
composer create-project ibexa/website-skeleton:~4.1.0@dev . --no-install
...
docker exec install_dependencies composer require ibexa/behat:~4.1.x-dev ibexa/docker:^0.2.x-dev --no-scripts --no-update
