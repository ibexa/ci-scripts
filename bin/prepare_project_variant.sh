...
# remove locks created when installing Docker dependency
...
composer require --no-update --prefer-dist ezsystems/behatbundle:"dev-fix-installationtype-for-flex as 8.3.x-dev"
